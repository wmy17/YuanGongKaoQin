...
class M_emo_model extends CI_Model{
	...
	public function page_read($per_page,$offset)//读取所有数据
	{
		$data=$this->db->limit($per_page,$offset)->get('emo');
		return $data->result();
	}
	...
	public function modifyData1($tablename,$data,$arr)
	{
		$data=$this->db->update($tablename,$data,$arr);
		return $this->db->affected_rows();
	}
