...
class M_admin_model extends CI_Model{
	...
	public function updateData($tablename,$data=array())
	{
		 
	}
	
	
	public function modifyData($tablename,$name,$pwd)
	{		
		$sql="update $tablename set pwd='$pwd' where name='$name'";
		$data=$this->db->query($sql);
		return $this->db->affected_rows();
	}
	
	public function print_att($tablename)
	{
