...
<ol class="breadcrumb" style ="background: #337AB7;">
    ...
    <li><a href ="<?php echo site_url('Pos/index')?>"
           target="right" style ="color: #fff;">职位信息查询删除和修改</a><>
</ol>
<table class ="table">
    <tr class ="row">
        <td>编 号</td><td>职 位</td><td>编 辑</td>
    </tr>
    ...
    <?php foreach($data as $v):?>
        <tr class="row">
            ...
            <td>
                <a href="<?php echo site_url('Pos/del/'.$v->id)?>"
                   class="btn btn-default btn-sm">删除</a>
                <a href="<?php echo site_url('Pos/edit/'.$v->id)?>"
