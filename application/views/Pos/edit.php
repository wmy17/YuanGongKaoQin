...
<ol class="breadcrumb" style ="background: #337AB7;">
    ...
    <li><a href="<?php echo site_url('Pos/add')?>"
           target="right" style ="color: #fff;">职位信息添加</a></li>
    <li><a href ="<?php echo site_url('Pos/index')?>" target="right" style ="color: #fff;">职位信息查询删除和修改</a></li>
</ol>
<div class="panel panel-body">
    <div class="panel-body" style="margin: 50px 50px;">
        <?php echo form_open('Pos/doedit')?>
